...
const zh: Messages = {
  ...
  auth: {
    ...
    errorGeneric: "登录链接发送失败，请重试。",
  },
  dashboard: {
    title: "检查历史",
    empty: "暂无检查记录——在主页运行一次检查后会显示在这里。",
    filterCategory: "类别",
  ...
  team: {
    ...
    inviteButton: "邀请",
    inviting: "邀请中...",
    inviteLinkGenerated: "邀请链接已生成——复制后通过您喜欢的方式（WhatsApp、邮件、Slack 等）发送给团队成员。",
    copyLink: "复制链接",
    linkCopied: "已复制！",
    inviteErrorGeneric: "生成邀请失败，请重试。",
    membersTitle: "成员",
    ownerOnlyNotice: "只有账户所有者可以邀请团队成员。",
  },
  billing: {
    title: "账单",
    currentPlan: "当前套餐",
    freePlan: "免费版",
    proPlan: "专业版",
    freeDescription: (limit) => `每月 ${limit} 次检查，团队共享。`,
    proDescription: "无限次检查，团队共享。",
    upgradeButton: "开始 14 天免费试用",
    trialNote: "需绑定信用卡。试用期结束前不会扣款，期间可随时取消。",
    manageButton: "管理账单",
    upgrading: "正在跳转至结账页面...",
    quotaExceeded: "您的团队已用完本月免费检查次数。升级到专业版即可无限使用。",
  },
};
